                ...
                <div style={styleObjUl}>
                    ...
                    <div>
                        <a href="#" onClick={(e) => handleCartClick(e)} style={{...styleA, position: "relative"}}>
                            ...
                            <div style={{ position: "absolute", top: "50%", left: "50%", transform: "translate(-50%, -50%)" }}>{cart.length}</div>
                        </a>
                    </div>
                </div>
            </div>
                ...
                {plantsArray.map((category, index) => ( // Loop through each category in plantsArray
                    <div key={index}> {/* Unique key for each category div */}
                        ...
                        {category.plants.map((plant, plantIndex) => {
                            const isInCart = cart.find(p => p.name === plant.name)
                            ...
                            <button
                                className={isInCart ? "product-button__disabled": "product-button"}
